...
pub type SyntaxNodeChildren = rowan::SyntaxNodeChildren<PapyrusLanguage>;
pub type SyntaxElementChildren = rowan::SyntaxElementChildren<PapyrusLanguage>;
pub type PreorderWithTokens = rowan::api::PreorderWithTokens<PapyrusLanguage>;
...
impl SyntaxTreeBuilder {
    ...
    pub fn token(&mut self, kind: SyntaxKind, text: &str) {
        let kind = PapyrusLanguage::kind_to_raw(kind);

...
use crate::{AstNode, SyntaxNode, syntax_node::PapyrusLanguage};

/// A "pointer" to a [`SyntaxNode`], via location in the source code.
pub type SyntaxNodePtr = rowan::ast::SyntaxNodePtr<PapyrusLanguage>;
...
impl<N: AstNode> AstPtr<N> {
    ...
    pub fn kind(&self) -> papyrus_parser::SyntaxKind {
        self.raw.kind()
    }
